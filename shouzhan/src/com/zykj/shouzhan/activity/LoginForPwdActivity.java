...
public class LoginForPwdActivity extends BaseActivity {
	...
	@Bind(R.id.rl_login_pwd_click) 	RelativeLayout rl_login_pwd_click;		//密码设置-确定按钮
	@Bind(R.id.et_login_pwd_first)	EditText	   et_login_pwd_first;		//第一次输入密码
	@Bind(R.id.et_login_pwd_two)		EditText	   et_login_pwd_two;			//第二次输入密码
