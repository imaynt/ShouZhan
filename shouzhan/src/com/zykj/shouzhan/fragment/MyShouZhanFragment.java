...
public class MyShouZhanFragment extends Fragment implements IXListViewListener {
	 ...
	 * @return 实例化收入列表
	 */
	public static MyShouZhanFragment getInstance(int type) {
		MyShouZhanFragment fragment = new MyShouZhanFragment();
